    ...
    <div className="flex flex-col min-h-screen">
      <section className="section-gradient py-24 md:py-32 border-b border-gray-100">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <FadeIn>
            <span className="eyebrow mb-4 inline-block">About Crettyard Digital</span>
      ...
      <section className="py-28 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <FadeIn className="mb-14">
            <span className="eyebrow mb-4 inline-block">Who I Help</span>
          ...
          <StaggerContainer className="grid sm:grid-cols-2 gap-6 mb-20">
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-who-tradespeople">
                <HardHat className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Tradespeople & Contractors</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Electricians, plumbers, builders, landscapers — anyone who wins work locally and needs to be found on Google.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-who-professional">
                <Briefcase className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Professional Services</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Accountants, solicitors, consultants, and therapists who need a polished online presence that builds trust.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-who-retail">
                <Store className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Retailers & Hospitality</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Shops, cafés, and B&Bs who want to attract visitors, take bookings, or simply show up when people search.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-who-service">
                <Wrench className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Service Businesses</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Cleaners, pest control, skip hire, vehicle recovery — businesses that rely on local enquiries to keep busy.</p>
                </div>
              </div>
            </StaggerItem>
          </StaggerContainer>
          ...
          <FadeIn className="mb-8">
            <span className="eyebrow mb-4 inline-block">Common Concern</span>
          ...
          <FadeIn className="mb-20">
            <div className="border border-gray-200/80 rounded-[4px] p-8 bg-gray-50/50" data-testid="section-objection-handling">
          ...
          <FadeIn>
            <span className="eyebrow mb-4 inline-block">Why Work With Me</span>
            <h2 className="text-3xl mt-4 mb-8">What sets Crettyard Digital apart</h2>
          </FadeIn>

          <StaggerContainer className="grid sm:grid-cols-2 gap-6 mb-20">
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-trust-enterprise">
                <Shield className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Enterprise Background</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Years of experience at Microsoft, Intel, and Dell — applied to your small business. You get big-company standards at SME-friendly prices.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-trust-plain-english">
                <Languages className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Plain English</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">No buzzwords, no tech-speak. I explain what I'm doing, why it matters, and what it costs — in language that makes sense.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-trust-local">
                <MapPin className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Local Focus</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">Based on the Laois–Carlow border, serving businesses across Laois, Carlow, Kilkenny, and surrounding areas. I understand local business.</p>
                </div>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="border border-gray-200/80 p-7 rounded-[4px] card-hover flex gap-4 items-start" data-testid="card-trust-direct">
                <MessageSquare className="text-accent mt-1 shrink-0" size={22} />
                <div>
                  <h3 className="text-lg font-bold mb-2">Direct Communication</h3>
                  <p className="text-foreground/70 text-[15px] leading-relaxed">You deal directly with Joey — the person doing the work. No call centres, no ticketing systems, no waiting days for a reply.</p>
                </div>
              </div>
            </StaggerItem>
          </StaggerContainer>
          ...
          <FadeIn className="mb-14">
            ...
            <p className="text-foreground/70 max-w-2xl">Everything you need to get online, stay secure, and look professional — from one trusted partner.</p>
          </FadeIn>

          <StaggerContainer className="grid sm:grid-cols-3 gap-6">
            <StaggerItem>
              <Link href="/web-design">
                <div className="border border-gray-200/80 p-6 rounded-[4px] card-hover text-center cursor-pointer" data-testid="card-service-web">
                  <MonitorSmartphone className="text-accent mx-auto mb-4" size={24} />
                  <h3 className="text-sm font-bold mb-2">Web Design</h3>
                  <p className="text-foreground/70 text-[13px] leading-relaxed">Fast, SEO-ready websites that help you get found and win more enquiries.</p>
                </div>
              </Link>
            </StaggerItem>
            <StaggerItem>
              <Link href="/microsoft-365">
                <div className="border border-gray-200/80 p-6 rounded-[4px] card-hover text-center cursor-pointer" data-testid="card-service-m365">
                  <Cloud className="text-accent mx-auto mb-4" size={24} />
                  <h3 className="text-sm font-bold mb-2">Microsoft 365</h3>
                  <p className="text-foreground/70 text-[13px] leading-relaxed">Professional email, Teams, and cloud storage — set up properly from day one.</p>
                </div>
              </Link>
            </StaggerItem>
            <StaggerItem>
              <Link href="/network-wifi-security">
                <div className="border border-gray-200/80 p-6 rounded-[4px] card-hover text-center cursor-pointer" data-testid="card-service-network">
                  <Wifi className="text-accent mx-auto mb-4" size={24} />
                  <h3 className="text-sm font-bold mb-2">Network & Wi-Fi</h3>
                  <p className="text-foreground/70 text-[13px] leading-relaxed">Reliable coverage, secure firewalls, and proper setup for offices and workshops.</p>
                </div>
              </Link>
            </StaggerItem>
          </StaggerContainer>
      ...
      <section className="py-24 section-gradient border-t border-gray-100 text-center">
        <div className="container mx-auto px-4">
          <FadeIn>
            <h2 className="text-3xl mb-4">Let's Talk About Your Business</h2>
