          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <FadeIn>
              <div className="text-center md:text-left">
                ...
                <p className="text-white/70 mb-8 leading-relaxed font-sans font-normal">You do not need to figure all of this out alone. If you want a calmer, more practical way to protect your children online, request a setup and I'll help you choose the right approach for your home.</p>
                <a href="#request-form">
