          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <FadeIn>
              <div className="text-center md:text-left">
                ...
                <p className="text-white/70 mb-8 font-sans font-normal leading-relaxed">Book a free, no-obligation consultation. I'll give you honest advice — whether you're just starting out or want to improve what you already have.</p>
            ...
            <div className="hidden md:block absolute left-1/2 top-12 bottom-12 w-px bg-white/10" aria-hidden="true" />
            ...
            <FadeIn delay={0.1}>
              <div className="text-center md:text-left md:border-l md:border-white/10 md:pl-16">
                ...
                <h2 className="text-2xl md:text-3xl text-white mb-3" data-testid="text-social-heading">Follow Us for Tips, Offers &amp; Updates</h2>
                <p className="text-white/60 font-sans font-normal mb-8 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2.5 px-7 py-3 rounded-full bg-[#1877F2] text-white font-semibold text-sm hover:bg-[#1565d8] transition-colors shadow-sm"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2.5 px-7 py-3 rounded-full text-white font-semibold text-sm transition-colors shadow-sm"
