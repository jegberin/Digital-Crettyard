      ...
      <section className="py-16 bg-white text-center border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-2xl">
          <FadeIn>
            ...
            <h2 className="text-2xl md:text-3xl mb-3" data-testid="text-social-heading">Follow Us for Tips, Offers &amp; Updates</h2>
            <p className="text-foreground/60 font-sans font-normal mb-8 max-w-lg mx-auto leading-relaxed">
