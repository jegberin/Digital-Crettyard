...
const tocItems = [
  ...
  { id: "section-11", label: "11. Payments" },
  { id: "section-12", label: "12. Cancellation and refunds" },
  { id: "section-13", label: "13. Timelines and delivery" },
  { id: "section-14", label: "14. Support and maintenance" },
  { id: "section-15", label: "15. Limitation of liability" },
  { id: "section-16", label: "16. No guarantees" },
  { id: "section-17", label: "17. Indemnity" },
  { id: "section-18", label: "18. Links to third-party websites" },
  { id: "section-19", label: "19. Privacy" },
  { id: "section-20", label: "20. Governing law" },
  { id: "section-21", label: "21. Changes to these terms" },
  { id: "section-22", label: "22. Contact" },
];
          ...
          <div className="prose prose-lg max-w-none text-foreground/80 space-y-10" data-testid="text-terms-conditions">
            ...
            <div id="section-1">
              ...
              <ul className="list-none space-y-1 pl-0">
                <li>Email: <a href="mailto:info@crettyard.ie" className="text-accent hover:underline">info@crettyard.ie</a></li>
