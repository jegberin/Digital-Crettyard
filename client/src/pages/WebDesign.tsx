      ...
      <section className="py-24 bg-primary dot-matrix-bg text-center">
        <div className="container mx-auto px-4 max-w-2xl">
          <FadeIn>
            ...
            <p className="text-white/70 mb-8 font-sans font-normal max-w-xl mx-auto leading-relaxed">Book a free, no-obligation consultation and I'll show you exactly how a professional website can help you win more customers.</p>
            <Link href="/contact#send-message">
