          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <FadeIn>
              <div className="text-center md:text-left">
                ...
                <p className="text-white/70 mb-8 leading-relaxed font-sans font-normal">Book a free, no-obligation consultation. I'll assess your current setup, recommend the right plan, and give you a clear quote — in plain English.</p>
